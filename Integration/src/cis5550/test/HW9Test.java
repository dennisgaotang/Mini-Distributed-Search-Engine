...
public class HW9Test extends HW9GenericTest {
	...
	void runTests(Set<String> tests) throws Exception {
		...
		if (tests.contains("indexer")) try{
			...
			data.put("http://foo.com/page1.html", "are only you you you apple apples apple banana bananas figs figs figs fig coconuts");
			data.put("http://foo.com/page2.html", "you may only apple dates bananas banana elderberries figs");
			data.put("http://foo.com/page3.html", "again any guavas hazelnuts apple ");
			installCrawl(data);
