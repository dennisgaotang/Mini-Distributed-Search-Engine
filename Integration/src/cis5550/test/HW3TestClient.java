...
public class HW3TestClient extends HW3GenericTest {
  ...
  void prompt() {
    ...
    System.out.println("In another terminal window, please run 'java cis5550.cis5550.test.HW3TestServer, and then hit Enter in this window to continue.");
  ...
  void runTests(Set<String> tests) throws Exception {
    ...
    if (numTestsFailed == 0)
      ...
      System.out.println(numTestsFailed+" cis5550.test(s) failed.");
